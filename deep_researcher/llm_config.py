...
REASONING_MODEL_PROVIDER = get_env_with_prefix("REASONING_MODEL_PROVIDER", default="openai")
...
SEARCH_PROVIDER = get_env_with_prefix("SEARCH_PROVIDER", default="serper")
