...
class LongWriterOutput(BaseModel):
    ...
    references: Optional[List[str]] = Field(description="A list of URLs and their corresponding reference numbers for the section", default_factory=list)
...
- If no references are found, output an empty list for the references field
...
async def write_report(
    ...
    for section in report_draft.sections:
        ...
        section_markdown, all_references = reformat_references(
            ...
            next_section_draft.references or [],
            all_references
        )
